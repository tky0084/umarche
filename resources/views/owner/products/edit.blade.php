                        ...
                        <div class="-m-2">
                                    ...
                                    <div class="p-2 w-1/2 mx-auto">
                                        <div class="relative">
                                            ...
                                            <span class="test-sm">0～99の範囲で入力してください</span>
                                         </div>
                                    </div>

                          <div class="p-2 w-1/2 mx-auto">
                            <div class="relative">
                            <label for="shop_id" id="shop_id" class="leading-7 text-sm text-gray-600">販売する店舗 ※必須</label>
                          ...
                          <div class="p-2 w-1/2 mx-auto">
                            <div class="relative">
                            <label for="category" id="category" class="leading-7 text-sm text-gray-600">カテゴリー ※必須</label>
