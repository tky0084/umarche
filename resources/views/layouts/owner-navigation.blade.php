        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('owner.images.index')" :active="request()->routeIs('owner.images.dashboard')">
                        画像管理
                    </x-nav-link>
                    <x-nav-link :href="route('owner.products.index')" :active="request()->routeIs('owner.products.dashboard')">
                        商品管理
                    </x-nav-link>
                </div>
            </div>
